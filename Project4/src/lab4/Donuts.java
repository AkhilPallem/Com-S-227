...
public class Donuts
{
  ...
  {
    double dozens = donuts / 12;
    int singles = donuts % 12;
    int freeCoffees = (int)(dozens * 2);
    coffees = coffees - freeCoffees;
    double donutCost = (dozens * 8.00) + (singles * 0.75);
    double coffeeCount = coffees * 1.50;
    return donutCost + coffeeCount;
  }
}